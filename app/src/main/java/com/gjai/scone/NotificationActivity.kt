...
class NotificationActivity : AppCompatActivity() {
    ...
    var notification_List = arrayListOf<NotificationItem>(
        ...
        NotificationItem(
            "쿠폰이 전해졌습니다",
            "장범준님께서 조커님이 보내신 선물을 받았습니다.",
            "(감사인사 받기를 놓치지 마세요.)",
            "10월 25일 08:25"
        ),
        NotificationItem(
            "쿠폰이 전해졌습니다",
            "판테온님께서 조커님이 보내신 선물을 받았습니다.",
            "(감사인사 받기를 놓치지 마세요.)",
            "10월 21일 11:10"
        ),
        NotificationItem(
            "쿠폰이 전해졌습니다",
            "장규리님께서 조커님이 보내신 선물을 받았습니다.",
            "(감사인사 받기를 놓치지 마세요.)",
            "10월 19일 19:30"
        ),
        NotificationItem(
            "쿠폰이 전해졌습니다",
            "이새롬님께서 조커님이 보내신 선물을 받았습니다.",
            "(감사인사 받기를 놓치지 마세요.)",
            "10월 16일 10:32"
        ),
        NotificationItem(
            "쿠폰이 전해졌습니다",
            "백종원님께서 조커님이 보내신 선물을 받았습니다.",
            "(감사인사 받기를 놓치지 마세요.)",
            "10월 14일 15:58"
        )
    )
...
data class NotificationItem(var name: String, var text_1: String,var text_2: String, var timestamp: String)
